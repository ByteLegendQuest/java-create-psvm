...
`git clone https://github.com/ByteLegendQuest/java-create-psvm`

A project directory named `java-create-psvm` will be created, which can be moved wherever you like.

Open `IDEA`, `File` - `Open`, select and open the `pom.xml` in `java-create-psvm` directory which is created just now.
